...
StarforgeMarkedShot = StarforgeGunFire:new()

function StarforgeMarkedShot:new(abilityConfig)
...
function StarforgeMarkedShot:update(dt, fireMode, shiftHeld)
...
function StarforgeMarkedShot:aim()
...
function StarforgeMarkedShot:fire()
...
function StarforgeMarkedShot:idle()
  activeItem.setScriptedAnimationParameter("entities", {})
  self.targets = {}
  idle()
end

function StarforgeMarkedShot:reset()
  activeItem.setScriptedAnimationParameter("entities", {})
  self.targets = {}
end

function StarforgeMarkedShot:uninit()
  self:reset()
end

function StarforgeMarkedShot:findTarget()
